...
\begin{center}
    ...
    \smallskip
    \homeico 444 N. 4th St. Apt. 815, Philadelphia, PA 19123 \\
...
\begin{tabularx}{\textwidth}{@{}p{6em}|X@{}}
    ...
    \multicolumn{2}{c}{} \\
    \textit{InDev.} & Bulding an application targetted towards music students to aid in rhythmic training using techniques from Dalcroze Eurhythmics. \\
    \multicolumn{2}{c}{} \\
    \textit{Complete} & A textfile compression utility that makes use of Huffman coding to reduce file sizes
\end{tabularx}
